...
galleryTh.forEach(galleryTh=>{
    galleryTh.addEventListener("click",event=>{
        ...
        imgContGall.style.backgroundImage=`url("../../ecommerce-product-page-main/images/image-product-${galleryThIndex}.jpg")` 
    })
})
let modalIndex=1;
...
Th.forEach(Th=>{
    Th.addEventListener("click",event=>{
        ...
        imgCont.style.backgroundImage=`url("../../ecommerce-product-page-main/images/image-product-${ThIndex}.jpg")` 
    })
})
